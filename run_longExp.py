...
parser.add_argument('--j_type', type = str, default = 'up', help = 'j type wavelet transform')
parser.add_argument('--factor', type = int, default = 5, help = 'factor for wavelet transform')
parser.add_argument('--d_model', type=int, default=256, help='dimension of model')
parser.add_argument('--multi_levels', type=int, default=3, help='multiscale embedding levels')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_pl{}_p{}_j{}_{}_{}_{}_{}_seed{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
    ...
    ii = 0
    setting = '{}_{}_{}_ft{}_sl{}_pl{}_p{}_j{}_{}_{}_{}_seed{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
